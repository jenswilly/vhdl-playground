...
set_property SEVERITY {Warning} [get_drc_checks NSTD-1] ;# Suppress errors about unconnected pins
...
## LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { led1_r }]; #IO_L12N_T1_MRCC_16 Sch=led[1]
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports { led1_g }]; #IO_L13P_T2_MRCC_16 Sch=led[2]
...
set_false_path -to [get_ports {led0_r led0_g led0_b led1_r led1_g}]
set_output_delay 0 [get_ports {led0_r led0_g led0_b led1_r led1_g}]

## Buttons
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { reset_pin }]; # Active high
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { gpio_ja1 }]; #IO_L5N_T0_D07_14 Sch=ja[1]
...
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { gpio_ja2 }]; #IO_L4N_T0_D05_14 Sch=ja[2]
set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { gpio_ja3 }]; #IO_L9P_T1_DQS_14 Sch=ja[3]
